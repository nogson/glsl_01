...
},{"./../shader/base.frag":7,"./../shader/base.vert":8}],3:[function(require,module,exports){
'use strict';
...
module.exports = function () {
    ...
    _createClass(Offscreen, [{
        ...
        value: function render(time, data) {
            var self = this;
            var audioData = this.utils.sum(data);
            var audioDataLength = data.length;
            var v = audioData / audioDataLength * 0.01;
...
},{"./../shader/post.frag":9,"./../shader/post.vert":10,"./utils.js":6}],6:[function(require,module,exports){
"use strict";
